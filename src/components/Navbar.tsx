    ...
    <>
      ...
      <header className="sticky top-0 z-40 w-full backdrop-blur-xl bg-[#080B11]/85 border-b border-slate-800/80 transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          {/* Right Actions: Client Portal + Admin + Free Call Button */}
          <div className="hidden sm:flex items-center gap-2.5">
            <button
              id="nav-admin-btn"
              onClick={() => handleNavClick('admin')}
              title="Admin Panel & Databases (or press Alt+A)"
              className="px-3 py-2 rounded-xl bg-slate-900/90 hover:bg-slate-800 border border-slate-700/80 hover:border-cyan-500/50 text-slate-300 hover:text-cyan-400 text-xs font-mono font-medium flex items-center gap-1.5 transition-all cursor-pointer"
            >
          ...
          <div className="flex sm:hidden items-center gap-1.5">
            <button
              ...
              onClick={() => handleNavClick('admin')}
              className="px-2 py-1.5 rounded-lg bg-slate-900 border border-slate-700 text-slate-300 hover:text-cyan-400 font-mono text-xs flex items-center gap-1"
              title="Admin Panel"
            >
